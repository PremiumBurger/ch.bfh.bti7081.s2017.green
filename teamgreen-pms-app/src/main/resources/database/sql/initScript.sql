...
CREATE TABLE Person (id BIGINT AUTO_INCREMENT NOT NULL, personType VARCHAR(50) NOT NULL, addressId BIGINT NULL, genderTypeId BIGINT NOT NULL, firstName VARCHAR(255) NULL, lastName VARCHAR(255) NULL, birthDate date NULL, phone VARCHAR(50) NULL, mobile VARCHAR(50) NULL, ahvNr VARCHAR(16) NULL, email VARCHAR(255) NULL, CONSTRAINT PK_PERSON PRIMARY KEY (id), CONSTRAINT fk_person_gender FOREIGN KEY (genderTypeId) REFERENCES GenderType(id), CONSTRAINT fk_person_address FOREIGN KEY (addressId) REFERENCES Address(id));

...
--  Lock Database
UPDATE DATABASECHANGELOGLOCK SET LOCKED = 1, LOCKEDBY = 'DESKTOP-TLLCFAS (147.87.41.135)', LOCKGRANTED = '2017-05-16 20:59:37.707' WHERE ID = 1 AND LOCKED = 0;
...
CREATE TABLE Alarm (id BIGINT AUTO_INCREMENT NOT NULL, healthVisitorId BIGINT NOT NULL, patientId BIGINT NULL, coordinates VARCHAR(255) NOT NULL, timestamp timestamp NOT NULL, CONSTRAINT PK_ALARM PRIMARY KEY (id), CONSTRAINT fk_alarm_patient FOREIGN KEY (patientId) REFERENCES Person(id), CONSTRAINT fk_alarm_healthvisitor FOREIGN KEY (healthVisitorId) REFERENCES Person(id));

CREATE TABLE Appointment (id BIGINT AUTO_INCREMENT NOT NULL, healthVisitorId BIGINT NOT NULL, patientId BIGINT NULL, `from` timestamp NOT NULL, `to` timestamp NOT NULL, CONSTRAINT PK_APPOINTMENT PRIMARY KEY (id), CONSTRAINT fk_appointment_healthvisitor FOREIGN KEY (healthVisitorId) REFERENCES Person(id), CONSTRAINT fk_appointment_patient FOREIGN KEY (patientId) REFERENCES Person(id));
...
CREATE TABLE JournalEntry (id BIGINT AUTO_INCREMENT NOT NULL, journalEntryType BIGINT NOT NULL, journalId INT NOT NULL, text VARCHAR(2000) NULL, isImportant BIT(1) NOT NULL, appointmentId BIGINT NULL, createdBy BIGINT NOT NULL, createdOn timestamp NOT NULL, modifiedOn timestamp NULL, CONSTRAINT PK_JOURNALENTRY PRIMARY KEY (id), CONSTRAINT fk_journalentry_person FOREIGN KEY (createdBy) REFERENCES Person(id), CONSTRAINT fk_journalentry_journal FOREIGN KEY (journalId) REFERENCES Journal(id), CONSTRAINT fk_journalentry_appointment FOREIGN KEY (appointmentId) REFERENCES Appointment(id));
...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('1', 'vonac1', 'src/main/resources/database/schema.changelog-master.xml', NOW(), 1, '7:d8638f098c69132059d6a649745ecdb8', 'createTable tableName=GenderType; createTable tableName=Address; createTable tableName=Person; createTable tableName=Alarm; createTable tableName=Appointment; createTable tableName=Journal; createTable tableName=JournalEntry; createTable tableName...', '', 'EXECUTED', NULL, NULL, '3.5.3', '4961178324');
...
INSERT INTO Appointment (id, healthVisitorId, patientId, intendedDateTime) VALUES ('1', '1', '2', '2017-10-30 08:00:00');

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, CONTEXTS, LABELS, LIQUIBASE, DEPLOYMENT_ID) VALUES ('testdata_2', 'schms27', 'src/main/resources/database/testdata.changelog-master.xml', NOW(), 4, '7:32d5064855f560f5b0c544170b68e795', 'insert tableName=Person; insert tableName=Appointment', '', 'EXECUTED', NULL, NULL, '3.5.3', '4961178324');
